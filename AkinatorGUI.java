...
class AkinatorGUI extends JFrame {
    ...
    Color accentGold = new Color(255, 196, 0);
    ...
    AkinatorGUI() {
        ...
        title = new JLabel("AKINATOR", SwingConstants.CENTER);
    ...
    void move(boolean ans) {
        ...
        if (ans) engine.current = engine.current.yes;
        else engine.current = engine.current.no;
